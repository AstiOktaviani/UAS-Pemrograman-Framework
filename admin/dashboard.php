		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">SMK NEGERI 1 LOPOK</b>
				</a>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="../assets/img/adminb.png" alt="" class="avatar-img rounded"></div>
											<div class="u-text">
		...
		<footer class="footer">
				<div class="container">
					...
					<div class="copyright ml-auto">
						...
						&copy; <?php echo date('Y');?> Absensi SMK NEGERI 1 LOPOK (<a href="index.php">Asti Okatviani </a> | 2022)
					</div>				
				</div>
			</footer>
		</div>
